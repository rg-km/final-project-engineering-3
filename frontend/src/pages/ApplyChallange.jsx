    ...
    <div className='container'>
        <div className='flex flex-wrap w-auto'>
            ...
            <div className='ml-auto'>
                <button to="#" className='px-10 py-1 rounded-full bg-blue-700 text-white font-semibold'>apply</button>
            </div>
        </div>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <button className="p-2 flex space-x-3 items-center bg-gray-100 w-full rounded-md">
                        <BsDownload /><span className='font-semibold'>File Panduan</span>
                    </button>
                </div> 
            </div>

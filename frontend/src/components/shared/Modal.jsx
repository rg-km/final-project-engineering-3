...
function Modal({ path }) {
  return (
    <div
      id="popup-modal"
      tabIndex="-1"
      className="fixed top-0 right-0 left-0 z-50 inset-0  bg-black/[0.2] flex items-center justify-center"
    >
      <div className="p-10 bg-white rounded-lg shadow-lg dark:bg-gray-700 ">
